...
@section('content')
    <div class="animate-fade-in">
        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-800">Data Jurusan</p>
                    <p class="text-xs text-gray-400">{{ $jurusans->total() }} data ditemukan</p>
                </div>
            </div>
            ...
            <table class="w-full text-left text-sm">
                <thead>
                    <tr class="border-b border-gray-100 bg-gray-50/50">
                        ...
                        <th class="px-5 py-3 text-xs font-semibold uppercase tracking-wider text-gray-400">Nama Jurusan</th>
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-5 py-3.5 text-right">
                                <div class="inline-flex items-center gap-0.5">
                                    ...
                                    <button type="button"
                                        onclick="openDeleteModal('{{ $jurusan->nama }}', '{{ route('admin.jurusan.destroy', $jurusan) }}', '{{ csrf_token() }}')"
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 hidden items-center justify-center p-4"
        ...
        <div class="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
            ...
            <h3 class="text-base font-semibold text-gray-900">Hapus Jurusan</h3>
            <p class="mt-1.5 text-sm text-gray-500 leading-relaxed">
                Yakin ingin menghapus <strong id="deleteItemName" class="text-gray-800"></strong>? Semua kelas dan
                data siswa di dalam jurusan ini akan ikut terhapus.
            </p>
